...
public class Guia11ExtraEj04 {
    ...
    public static void main(String[] args) {
        ...
        alumnos = simulador.generaListaAlumnos();
        System.out.println("Alumnos creados:");
        for (Alumno alumno : alumnos) {
            System.out.println(alumno);
        }
        System.out.println("");
        System.out.println("A continuación se realizan las votaciones.");
        votos = simulador.votacion(alumnos,facilitadores);
        simulador.mostrarVotosAlumnos(votos);
        System.out.println("");
        System.out.println("A continuación, se muestran los facilitadores.");
