 ...
 */
package guia.pkg13.ej01;

import Entidad.Personas;
import Service.ServicePersona;
import java.util.Arrays;

public class Guia13Ej01 {
...
con una cláusula try-catch para probar la nueva excepción que debe ser controlada.
    ...
    personas[0]=persona;
    personas[0].setEdad(null);
    ServicePersona spersona = new ServicePersona();
   
    System.out.println(Arrays.toString(spersona.mayorDeEdad(personas)));
    }
/*
